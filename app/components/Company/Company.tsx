...
const Company = () => {
  return (
    <div className='pt-[6rem] pb-[3rem]'>
      ...
      <p className='w-[90%] sm-w-[85%] md:w-[75%] lg:w-[55%] mx-auto text-[17px] text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo delectus aut voluptatum harum dolores unde enim neque distinctio id in? Alias distinctio itaque corrupti! Fugiat, eligendi mollitia. Quam, fugit dolor?</p>
