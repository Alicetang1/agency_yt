    ...
    <div className='pt-[5rem] pb-[3rem]'>
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[4rem] items-center'>
        ...
        <div className='order-1 lg:order-2'>
          ...
          data-aos-anchor-placement="top-center" 
          data-aos-delay="400"
          className='mt-[1.5rem] mb-[1.5rem] text-black opacity-90 text-[15px] md:text-[16px]'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi voluptas, sapiente amet accusantium reiciendis dignissimos excepturi eum mollitia, sed porro tempora et iste culpa tenetur! Obcaecati repellat aut commodi voluptatibus!</p>
          <div 
          data-aos="fade-up" 
          data-aos-anchor-placement="top-center" 
          data-aos-delay="600"
